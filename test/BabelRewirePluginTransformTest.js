...
describe("BabelRewirePluginTest", function() {
  ...
  function testSuccessfulTranslation(testName, additionalOptions) {
    ...
    var transformationResult = babel.transform(
      input,
  ...
  var stage0FeaturesToTests = ["issue164"];

  var ignoredIdentifiers = ["ignoredIdentifiers"];

  featuresToTest.forEach(function(feature) {
    it(
      "test babel-plugin-rewire for " + feature,
      testTranslation.bind(null, feature, babelTranslationOptions)
    );
  });
