...
var TextArea = _get__("React").createClass({
  ...
  */
  ...
  render: function() {
    var taStyle = _get__("_").extend(
      {},
      _get__("textAreaStyle").textarea,
      this.props.style.textarea
    );
    var labelStyle = _get__("_").extend(
      {},
      _get__("textAreaStyle").label,
...
var HiddenTextInput = _get__("React").createClass({
  ...
  */
  render: function() {
    return _get__("React").createElement("input", {
      type: "text",
