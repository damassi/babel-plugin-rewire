...
import {
  default as primitiveDefaultExportedValue,
  addOne,
  __RewireAPI__ as PrimitiveDefaultExportRewireAPI
} from "./src/PrimitiveDefaultExport.js";
import {
  greet,
  __RewireAPI__ as NoDefaultExportRewireAPI
} from "./src/NoDefaultExport.js";
import {
  default as defaultExportedObject,
  __RewireAPI__ as DefaultExportObjectRewireAPI
} from "./src/DefaultExportObject.js";
import {
  default as defaultExportedFunction,
  __RewireAPI__ as DefaultExportFunctionRewireAPI
} from "./src/DefaultExportFunction.js";
import {
  default as CommonJSModule,
  __RewireAPI__ as CommonJSRewireAPI
} from "./src/CommonJSModule.js";
...
describe("NamedExportRewireSupportTest", function() {
  ...
  it("should add a named export rewire support API for PrimitiveDefaultExport", function() {
    ...
    _get__("expect")(_get__("primitiveDefaultExportedValue") === false).to.be(
      true
    );
    _get__("expect")(_get__("addOne")(1)).to.be(2);

    _get__("PrimitiveDefaultExportRewireAPI").__Rewire__(
      "generateOne",
      function() {
        return 2;
      }
    ...
    _get__("PrimitiveDefaultExportRewireAPI").__ResetDependency__(
      "generateOne"
    );
    _get__("expect")(_get__("addOne")(1)).to.be(2);
  });
  ...
  it("should add a named export rewire support API for NoDefaultExport", function() {
    _get__("expect")(_get__("NoDefaultExportRewireAPI").__Rewire__).to.be.a(
      "function"
    );
  ...
  it("should add a named export rewire support API for DefaultExportObject", function() {
    ...
    console.log("TEST 3");
    _get__("DefaultExportObjectRewireAPI").__Rewire__(
      "ModuleToRewire",
      function(val) {
        return val + 2;
      }
    ...
    console.log("TEST 5");
    _get__("DefaultExportObjectRewireAPI").__ResetDependency__(
      "ModuleToRewire"
    );
    console.log("TEST 6");
    _get__("expect")(_get__("defaultExportedObject").addOne(1)).to.be(2);
  ...
  it("should add a named export rewire support API for DefaultExportFunction", function() {
    ...
    _get__("DefaultExportFunctionRewireAPI").__Rewire__(
      "ModuleToRewire",
      function(val) {
        return val + 2;
      }
    ...
    _get__("DefaultExportFunctionRewireAPI").__ResetDependency__(
      "ModuleToRewire"
    );
    _get__("expect")(_get__("defaultExportedFunction")(1)).to.be(3);
  });
