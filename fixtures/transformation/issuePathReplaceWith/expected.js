...
export function requiredValidatorFunction(translatedFieldLabel, fieldValue) {
  return (
    ...
    translatedFieldLabel + " is required."
  );
}

let _DefaultExportValue = _get__("createSingleFieldValidatorFactory")(
  _get__("requiredValidatorFunction")
);
...
function _get_original__(variableName) {
  switch (variableName) {
    case "createSingleFieldValidatorFactory":
